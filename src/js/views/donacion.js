...
export const Donacion = () => (
	<div className="text-center mt-5">
		{/* <h1>Donacion</h1> */}
		<div className="m-4 rounded border" style={{ borderColor: "rgb(54,160,164)" }}>
			<h2 className="mt-4 font-weight-bold">Gracias por apoyarnos!</h2>
			<img
			...
			<div className="table-responsive">
				<table className="container table table-bordered">
					<thead className="thead-primary" style={{ backgroundColor: "rgb(54,160,164)" }}>
						<tr>
				...
				<div className="m-3">
					<h4
						className="container p-2 mt-3 font-weight-bold"
						style={{ backgroundColor: "rgb(54,160,164)", color: "white" }}>
						Pago
					</h4>
					<form>
					...
					<button
						className="p2 m-2 btn btn-info"
						style={{ backgroundColor: "rgb(54,160,164)", color: "white", fontWeight: "bolder" }}>
						Completar
					</button>
				</div>
			</div>
